...
def ocr_using_google_api(image_path, request_url):
    ...
    if int_respose_code != 200:
        ...
        if json_response_data['responses'][0]:
            list_bounding_boxes = \
                json_response_data['responses'][0]['fullTextAnnotation']['pages'][0]['blocks']
...
df = ocr_using_google_api(
    "./invoice.jpg", "https://vision.googleapis.com/v1/images:annotate?key=AIzaSyBG1ivwQdb-uDJNR52oEen2Pq42qyhw2cM")
